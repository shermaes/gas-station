import { Grid, Heading, GridItem, Button, Stack, Box, Image } from "@chakra-ui/react";
...
export default function Resume() {
    ...
    //calculating the final price of the gas
    const finalPrice = priceGasoil.replace(",", ".") * quantity;
  
    //array of the data saved throughout the app
    const resumeData = [
      {
        title: "Surtidor",
        result: surtidor,
